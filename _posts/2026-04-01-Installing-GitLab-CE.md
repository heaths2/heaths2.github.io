...
cat << EOF > /etc/systemd/system/container-gitlab.service
# container-gitlab.service
# autogenerated by Podman 5.6.0
# Wed Apr  1 21:08:34 KST 2026
...
Type=oneshot
RemainAfterExit=yes
WorkingDirectory=/opt/iam
ExecStart=/usr/bin/podman compose -f /opt/gitlab/docker-compose.yml up -d
ExecStop=/usr/bin/podman compose -f /opt/gitlab/docker-compose.yml down
TimeoutStartSec=0
TimeoutStopSec=120
