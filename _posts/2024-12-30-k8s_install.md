...
<details style="margin: 1em 0; padding: 0.8em; border: 2px solid #007acc; border-radius: 10px; background-color: #f5faff; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);">
    <summary style="font-weight: bold; font-size: 1.2em; cursor: pointer; color: #007acc; display: flex; align-items: center; gap: 10px;">
      <i class="fas fa-chevron-circle-down"></i> 펼치기/접기
    </summary>
    <div style="margin-top: 0.5em; font-size: 1em; line-height: 1.5; color: #333;">
      여기에 숨겨질 내용을 넣으세요.  
      이 영역은 클릭 시 보이거나 숨길 수 있습니다.
    </div>
